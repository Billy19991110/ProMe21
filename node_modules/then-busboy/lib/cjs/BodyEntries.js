...
exports.BodyEntries = void 0;
const events_1 = require("events");
const Body_1 = require("./Body");
class BodyEntries extends events_1.EventEmitter {
    constructor() {
        super(...arguments);
    ...
    finish(isBodyRead) {
        ...
        if (__classPrivateFieldGet(this, _BodyEntries_isBodyRead, "f") === true && __classPrivateFieldGet(this, _BodyEntries_pending, "f") < 1) {
            this.emit("finish", new Body_1.Body(__classPrivateFieldGet(this, _BodyEntries_entries, "f")));
        }
    }
}
exports.BodyEntries = BodyEntries;
